...
🟢 Step 1: Clone / Download Project git clone https://github.com/Clixon28/Task-Manager cd WEEK-7
...
mongoose.connect("mongodb+srv://<username>:<password>@cluster0.xxxxx.mongodb.net/taskDB") 🔑 Replace:
